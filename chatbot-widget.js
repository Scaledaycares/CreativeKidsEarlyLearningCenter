...
function startConversation() {
    fetch('https://chatbot-for-creative-kids-learning-center--samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-creative-kids-learning-center--samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbz4UjG3385QhhgS4_2tDthEkf1YTS-R1m9O6r-Jz0uzjjCoLwxLf7bJw3Jlt8pGC_e9/exec';
